...
void SpaceStation::getPasses(String latitude, String longitude, ISS_pass* passData)
{
  ...
  JSON_Decoder json;      // Create an instance of the parser
...
***************************************************************************************/
void SpaceStation::key(const char *key) {
  currentKey = key;
...
***************************************************************************************/
void SpaceStation::value(const char *value) {
...
***************************************************************************************/
void SpaceStation::error( const char *message ) {
