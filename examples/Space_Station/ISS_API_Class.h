...
#include <JSON_Decoder.h>  // Decoder library https://github.com/Bodmer/JSON_Decoder

#include <JSON_Listener.h> // This is part of the JSON_Decoder library
...
class SpaceStation: public JsonListener {
  ...
  public:
    ...
    // void whitespace(char c); // No need to include functions if not used
